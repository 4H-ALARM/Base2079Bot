...
public class COTSswerveconfig {
    ...
    public COTSswerveconfig(double wheelDiameter, double angleGearRatio, double driveGearRatio, InvertedValue driveMotorInvert, InvertedValue angleMotorInvert, SensorDirectionValue cancoderInvert){
        ...
        this.cancoderInvert = cancoderInvert;
            ...
            public static final COTSswerveconfig KrakenX60Falcon500MK4i(double driveGearRatio){
                ...
                return new COTSswerveconfig(wheelDiameter, angleGearRatio, driveGearRatio, driveMotorInvert, angleMotorInvert, cancoderInvert);
            }
